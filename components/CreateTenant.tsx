        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1fr)', gap: '10px', alignItems: 'start' }}>
          <div style={{ display: 'grid', gap: '8px', paddingRight: '250px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '2px' }}>
              ...
              <div style={{ fontSize: '20px', color: 'var(--spacespot-navy-primary)', fontWeight: 700, lineHeight: 1.1 }}>Create New Tenant</div>
            </div>
            ...
            <div style={sectionCard}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '14px 14px' }}>
                <div>
                  ...
                  <input style={{ ...inputStyle, height: '30px', fontSize: '10px' }} value={form.tenantBrandName} onChange={(e) => updateField('tenantBrandName', e.target.value)} placeholder="e.g., ABC Phones" />
                </div>
                <div>
